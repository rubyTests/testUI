...
(function () {
	...
	nla.constant('defaultSettings', {
		alphabetcolors : ["#5A8770", "#6AD19F", "#6FA9AB", "#F5AF29", "#85A655", "#F18636", "#D93A37", "#A6B12E", "#5C9BBC", "#F5888D", "#9A89B5", "#407887", "#9A89B5", "#B49255", "#D33F33", "#A2B01F", "#F0B126", "#0087BF", "#D870AD", "#0087BF", "#B2B7BB", "#72ACAE", "#9C8AB4", "#5A8770", "#EEB424", "#407887"],
		textColor : '#ffffff',
		defaultBorder : 'border:5px solid white',
		fontsize : 18, // unit in pixels
