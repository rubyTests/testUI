...
$templateCache.put("slider.html","<ion-modal-view class=\"imageView CustomModalWindow\">\n  <ion-header-bar class=\"bar bar-header bar-assertive-900\"  ng-show=\"true\">\n  <div class=\"buttons buttons-left header-item\"> \n<span class=\"left-buttons\"> \n <button class=\"button button-icon button-clear ion-android-arrow-back\" ng-click=\"closeModal()\"></button>\n</span> \n</div>  \n <div class=\"h1 title\"></div> \n<div class=\"buttons buttons-right header-item\"> \n<span class=\"right-buttons\"> \n <button class=\"button button-icon button-clear ion-android-share-alt1\"></button>\n</span> \n</div>\n  </ion-header-bar>\n    \n  <ion-content class=\"\" scroll=\"false\">\n    <ion-slide-box does-continue=\"true\" active-slide=\"selectedSlide\" show-pager=\"false\" class=\"listContainer\" on-slide-changed=\"slideChanged($index)\">\n      <ion-slide class=\"SilderBgColor\" ng-repeat=\"single in slides track by $index\">\n        <ion-scroll direction=\"xy\"\n                    locking=\"false\" \n                    zooming=\"true\"\n                    min-zoom=\"1\"\n                    scrollbar-x=\"false\"\n                    scrollbar-y=\"false\"\n                    ion-slide-action\n                    delegate-handle=\"slide-{{$index}}\"\n                    overflow-scroll=\"false\"\n                    >\n        <div class=\"item item-image gallery-slide-view\">\n          <img ng-src=\"{{single.src}}\">\n        </div>\n        <div ng-if=\"false\" class=\"image-subtitle\" ng-show=\"!hideAll\">\n            <span ng-bind-html=\'single.sub\'></span>\n        </div>\n        </ion-scroll>\n      </ion-slide>\n    </ion-slide-box>\n  </ion-content>\n</ion-modal-view>");}]);
// $templateCache.put("slider.html","<ion-modal-view class=\"imageView CustomModalWindow\">\n  <ion-header-bar class=\"bar bar-header bar-assertive-900\"  ng-show=\"true\">\n  <div class=\"buttons buttons-left header-item\"> \n<span class=\"left-buttons\"> \n <button class=\"button button-icon button-clear ion-android-arrow-back\" ng-click=\"closeModal()\"></button>\n</span> \n</div>  \n <div class=\"h1 title\"></div> \n<div class=\"buttons buttons-right header-item\"> \n<srf-social-share data-config=\"linkShareCtrl.share\">\n</srf-social-share>\n</div>\n  </ion-header-bar>\n    \n  <ion-content class=\"\" scroll=\"false\">\n    <ion-slide-box does-continue=\"true\" active-slide=\"selectedSlide\" show-pager=\"false\" class=\"listContainer\" on-slide-changed=\"slideChanged($index)\">\n      <ion-slide class=\"SilderBgColor\" ng-repeat=\"single in slides track by $index\">\n        <ion-scroll direction=\"xy\"\n                    locking=\"false\" \n                    zooming=\"true\"\n                    min-zoom=\"1\"\n                    scrollbar-x=\"false\"\n                    scrollbar-y=\"false\"\n                    ion-slide-action\n                    delegate-handle=\"slide-{{$index}}\"\n                    overflow-scroll=\"false\"\n                    >\n        <div class=\"item item-image gallery-slide-view\">\n          <img ng-src=\"{{single.src}}\">\n        </div>\n        <div ng-if=\"false\" class=\"image-subtitle\" ng-show=\"!hideAll\">\n            <span ng-bind-html=\'single.sub\'></span>\n        </div>\n        </ion-scroll>\n      </ion-slide>\n    </ion-slide-box>\n  </ion-content>\n</ion-modal-view>");}]);