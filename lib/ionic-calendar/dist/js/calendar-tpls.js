...
angular.module("templates/rcalendar/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/rcalendar/month.html",
    ...
    "        <ion-slide ng-repeat=\"view in views track by $index\">\n" +
    "            <table ng-if=\"$index===currentViewIndex\" class=\"table table-bordered table-fixed monthview-datetable tablebar\">\n" +
    "                <thead>\n" +
    "                <tr>\n" +
...
angular.module("templates/rcalendar/monthviewEventDetail.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/rcalendar/monthviewEventDetail.html",
    ...
    "           <div class=\"list listclass\" ng-repeat=\"event in selectedDate.events\" ng-click=\"eventSelected({event:event})\">\n" +
   
    "                        <a class=\"item item-avatar \" ng-style=\"{}\" ui-sref=\"ViewEvents\" \n"  +
    "                         >\n " +
    "                              <img src=\"{{event.img}}\"> </i>\n" +
    "                              <h2 class=\"contnt\">{{::event.title}} </h2>\n" +
    "                                <p>  {{::event.startTime| date: 'hh:mm a'}} \n" +
    "                                -\n" +               
    "                                {{::event.endTime|date: 'hh:mm a'}}</p>\n" +
    "                        </a>\n" +
    "           </div>\n" +
